...
class MasterViewController: UITableViewController, NSFetchedResultsControllerDelegate {
    ...
    func insertNewObject(sender: AnyObject) {
        ...
        event.title = "\(self.fetchedResultsController.fetchedObjects!.count)個目"
        event.subTitle = "\(self.fetchedResultsController.fetchedObjects!.count)個目のオブジェクト"
    ...
    private lazy var fetchedResultsController: NSFetchedResultsController = {
        ...
        request.sortDescriptors = Event.defaultSortDescriptions
        
        let moc = StoreManager.sharedInstance.managedObjectContext
